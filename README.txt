...
After being serviced by the CPU, the process moves on to:
          the NetWork with probability .4, the disk with probability .1, or is done with probability .5
...
After being serviced by the disk, the process:
          circles back to get serviced by the CPU with probability .5, or moves on to the Network with probability .5
